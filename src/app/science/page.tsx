    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#f5f5f0]" style={{ fontFamily: playfair }}>
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="w-full flex flex-col items-center justify-center text-center">
          <div className="border border-[#f5f5f0]/30 px-12 md:px-24 py-16 md:py-24 w-full max-w-2xl">
      ...
      {/* Speed Comparison */}
      <section className="py-80 md:py-[28rem] px-6 border-t border-[#f5f5f0]/10">
        <div className="w-full flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-xl space-y-32">
            <div className="border border-[#f5f5f0]/40 p-16 md:p-24 text-center">
            ...
            <div className="border border-[#f5f5f0]/10 p-16 md:p-24 text-center">
      ...
      <section className="py-80 md:py-[28rem] px-6 bg-[#f5f5f0] text-[#0a0a0a]">
        <div className="w-full flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-xl space-y-80 md:space-y-[24rem]">
            <div className="border border-[#0a0a0a]/20 p-16 md:p-24 text-center">
      ...
      <section className="py-80 md:py-[28rem] px-6 bg-[#0a0a0a]">
        <div className="w-full flex flex-col items-center text-center">
          <div className="border border-[#f5f5f0]/20 p-12 md:p-20 mb-48 w-full max-w-xl">
            <h2 className="text-3xl md:text-5xl font-light">The Electrolytes</h2>
          </div>
          
          <div className="w-full max-w-xl space-y-48">
            <div className="border border-[#f5f5f0]/10 p-12 md:p-20 text-center">
              <h3 className="text-3xl font-light mb-12">Sodium</h3>
              <p className="text-[#f5f5f0]/40 text-lg md:text-xl leading-relaxed">
      ...
      <section className="py-80 md:py-[28rem] px-6 border-t border-[#f5f5f0]/10">
        <div className="w-full flex flex-col items-center text-center">
          ...
          <div className="border border-[#f5f5f0]/10 p-12 md:p-20 w-full max-w-xl space-y-10 text-[#f5f5f0]/40 text-xl text-center">
            <p>No added sugars</p>
